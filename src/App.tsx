...
const LOCATION_PAGES = [
  ...
  { label: 'Barber in Central Erin Mills', slug: 'barber-central-erin-mills' },
  ...
  { label: 'Barber near Sawmill Valley', slug: 'barber-sawmill-valley' },
  { label: 'Barber near Sheridan Homelands', slug: 'barber-sheridan-homelands' },
  { label: 'Barber near The Credit Woodlands', slug: 'barber-credit-woodlands' },
  { label: 'Barber near Glen Erin', slug: 'barber-glen-erin' },
  { label: 'Barber near The Collegeway', slug: 'barber-the-collegeway' },
  { label: 'Barber near Lisgar', slug: 'barber-lisgar' },
  { label: 'Barber near Creditview', slug: 'barber-creditview' },
  { label: 'Barber near Port Credit', slug: 'barber-port-credit' },
  { label: 'Barber near Clarkson', slug: 'barber-clarkson' },
  { label: 'Barber near Lorne Park', slug: 'barber-lorne-park' },
  { label: 'Barber near Lakeview', slug: 'barber-lakeview' },
  { label: 'Barber near Sheridan', slug: 'barber-sheridan' },
  { label: 'Barber near Cooksville', slug: 'barber-cooksville' },
  { label: 'Barber near Square One', slug: 'barber-square-one' },
  { label: 'Barber near Hurontario', slug: 'barber-hurontario' },
  { label: 'Barber near Mississauga Valley', slug: 'barber-mississauga-valley' },
  { label: 'Barber near East Credit', slug: 'barber-east-credit' },
  { label: 'Barber near Burnhamthorpe', slug: 'barber-burnhamthorpe' },
  { label: 'Barber near Applewood', slug: 'barber-applewood' },
  { label: 'Barber near Dixie', slug: 'barber-dixie' },
  { label: 'Barber near Rathwood', slug: 'barber-rathwood' },
