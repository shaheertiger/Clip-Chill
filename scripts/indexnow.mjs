#!/usr/bin/env node
/**
 * IndexNow submitter for Clip & Chill (https://www.clipandchill.com).
 *
...
const HOST = 'www.clipandchill.com';
const KEY = '13e0964e5e644e0895c51e06f6869ca4';
const KEY_LOCATION = `https://${HOST}/${KEY}.txt`;
// The sitemap is generated by the build (scripts/prerender.ts) into dist/. Fall
// back to public/ in case a prebuilt copy is committed there.
const DIST_SITEMAP = join(__dirname, '..', 'dist', 'sitemap.xml');
const PUBLIC_SITEMAP = join(__dirname, '..', 'public', 'sitemap.xml');
const SITEMAP_PATH = existsSync(DIST_SITEMAP) ? DIST_SITEMAP : PUBLIC_SITEMAP;
